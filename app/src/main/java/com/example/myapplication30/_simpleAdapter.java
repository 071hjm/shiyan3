...
public class _simpleAdapter extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.simpleadapter);//设置当前视图
        listView = (ListView) findViewById(R.id.listView1);//寻找listView
        dataList = new ArrayList<Map<String, Object>>();//新建数组
        //类数据源的准备工作
        for (int i = 0; i < 6; i++) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(_simpleAdapter.this, context.getText().toString(), Toast.LENGTH_SHORT).show();
